    ...
    <div className="flex-1 p-4 flex flex-col gap-4 xl:flex-row">
      ...
      <div className="w-full xl:w-2/3">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          {/* USER INFO CARD */}
          <div className="bg-sageYellow py-6 px-4 rounded-md flex-1 flex gap-4">
            <div className="w-1/3">
              <Image 
            ...
            <h1 className="text-xl font-semibold">SIME Student</h1>
            <p className="text-sm text-gray-500">Smart Integrated Management Engine</p>
            <div className="flex items-center justify-between gap-2 flex-wrap text-xs font-medium">
              ...
              <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
                ...
                <span>info@gnggroup.com</span>
              </div>
              <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
                <Image src='/phone.png' alt='' width={14} height={14}/>
                <span>+224627420416</span>
              </div>
            </div>
            </div>
          </div>
