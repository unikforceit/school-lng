...
export const resourceConfig: Record<ResourceType, { title: string; primary: string; fields: ReturnType<typeof field>[] }> = {
  ...
  results: { title: "Results", primary: "student", fields: [field("subject", "Subject"), field("student", "Student"), field("score", "Score", "number"), field("coefficient", "Coefficient", "number"), field("teacher", "Teacher"), field("class", "Class"), field("term", "Période"), field("date", "Date", "date"), field("type", "Type")] },
